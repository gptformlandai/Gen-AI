...
class HashingTfidfEmbeddingModel:
    """Deterministic local embedding model used for retrieval experiments."""
    ...
    def embed(self, text: str) -> list[float]:
        ...
        for token, frequency in Counter(self._expanded_tokens(text)).items():
